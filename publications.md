...
2. [Control for autonomous drone racing](https://repository.tudelft.nl/islandora/object/uuid%3A99f41ef5-f2c9-4a0a-9b89-0245e106f6de)
    ...
    <div style="text-align:center"><img src="./img/publications/alphapilot.jpg" width="600px"><br><em> Project at MAVLab-TUDelft </em></div>
...
3. [Li-Fi swarm robots with visual odometry](https://link.springer.com/chapter/10.1007/978-3-319-67934-1_18) - systems paper
    <div style="text-align:center"><img src="./img/publications/swarm-lifi.jpg" width="600px"><br><em>Project at SRA-VJTI</em></div>
...
4. [Motor driver using charge pumps](https://ieeexplore.ieee.org/abstract/document/7443724/)
    <div style="text-align:center"><img src="./img/publications/proteus.jpg" width="500px"><br><em>Project at SRA-VJTI</em></div>
...
1. AlphaPilot challenge: 
    ...
    <div style="text-align:left"><img src="./img/publications/65.jpg" width="300px"><br><em>World champions!</em></div>

2. Asia Pacific Robocon
    <div style="text-align:left"><img src="./img/publications/64.jpg" width="400px"><br><em>We qualify for the international league!</em></div>
    <div style="text-align:left"><img src="./img/publications/62.jpg" width="400px"><br><em>and one more!</em></div>
    <div style="text-align:left"><img src="./img/publications/61.jpg" width="400px"><br><em>and one more from the SRA days!</em></div>
